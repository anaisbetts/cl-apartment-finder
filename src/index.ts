...
const rssFeed = process.env.RSS_FEED || 'https://sfbay.craigslist.org/search/apa?availabilityMode=0&bundleDuplicates=1&format=rss&max_price=6000&min_bedrooms=3&postal=94107&search_distance=2';
